...
public class UnfavouriteCocktailIntegrationTest {
    ...
    @Test
    @WithMockUser
    public void givenFavouriteCocktails_whenDeleteFavouriteCocktails_thenReturnNewJsonArray() throws Exception {
        long id = 44;
        ...
        Cocktail mimosa = new Cocktail("Mimosa");
